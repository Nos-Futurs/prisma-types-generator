...
import type { DisconnectDtoParams, ImportStatementParams } from '../types';
import { TemplateHelpers } from '../template-helpers';

interface ComputeDisconnectDtoParamsParam {
  model: DMMF.Model;
  templateHelpers: TemplateHelpers;
}
export const computeDisconnectDtoParams = ({
  model,
  templateHelpers,
}: ComputeDisconnectDtoParamsParam): DisconnectDtoParams => {
